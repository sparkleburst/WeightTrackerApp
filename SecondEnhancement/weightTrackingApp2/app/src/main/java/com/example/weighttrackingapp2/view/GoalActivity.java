...
public class GoalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fetch and display the latest weight entry
        //int latestWeight = goalViewModel.getLatestWeight(LoginActivity.loggedInEmail);
        //if (latestWeight != -1) {
        //binding.currentWeight.setText(String.valueOf(latestWeight));
        //}
