...
public class WeightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("WeightActivity", "onCreate called");
        ...
        binding.weightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (weight.isEmpty()) {
                    ...
                    if (insert) {
                        Toast.makeText(WeightActivity.this, "Current Weight Added Successfully", Toast.LENGTH_SHORT).show();
                        weightViewModel.updateCurrentWeight(weight); // Update the current weight
                        Intent intent = new Intent(getApplicationContext(), ResultsActivity.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(WeightActivity.this, "Failed to add Current Weight. Please Try Again", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
